...
$$
But $L/D$ changes with airspeed
![[dragCurve.png|300]]

For derivation refer to [[aero101#Equations]]


## Battery sizing
### Power sizing
$$
P_{max} = \frac{1}{\eta_{powertrain}} \times max(P_{hover}, P_{cruise})
$$

Depending on the size of the aircraf
